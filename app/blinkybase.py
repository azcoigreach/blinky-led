...
class BlinkyBase(argparse.ArgumentParser):
    def __init__(self, *args, **kwargs):
        super(BlinkyBase, self).__init__(*args, **kwargs)
        ...
        self.add_argument("-c", "--chain", action = "store", help = "Daisy-chained boards. Default: 1.", default = 4, type = int)
    ...
    def process(self):
        ...
        try:
            # Start loop
            print("Press CTRL-C to stop blinky")
            self.Run()
